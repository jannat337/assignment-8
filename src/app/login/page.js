  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-5">
      <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full border border-orange-100 animate__animated animate__fadeIn">
        ...
        {error && (
          <div className="bg-red-50 text-red-500 p-3 rounded-lg text-sm mb-4 font-medium text-center">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-orange-500 hover:bg-orange-600 text-white py-2.5 rounded-lg font-bold transition shadow-sm">
            Login
          </button>
        </form>
        ...
        <button onClick={handleGoogleLogin} className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 py-2.5 rounded-lg font-semibold flex items-center justify-center gap-2 transition">
          <svg className="w-5 h-5" viewBox="0 0 24 24">
            <path fill="#EA4335" d="M12.24 10.285V14.4h6.887c-.275 1.565-1.88 4.604-6.887 4.604-4.33 0-7.866-3.577-7.866-8s3.536-8 7.866-8c2.46 0 4.105 1.025 5.047 1.926l3.227-3.102C18.445 2.025 15.605 1 12.24 1V1c-6.075 0-11 4.925-11 11s4.925 11 11 11c6.34 0 10.556-4.43 10.556-10.73 0-.726-.077-1.282-.175-1.685H12.24z"/>
          </svg>
          Google
        </button>
