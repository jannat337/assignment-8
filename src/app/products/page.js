      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {allProducts.map((product) => (
            <div key={product.id} className="bg-white rounded-xl shadow-md overflow-hidden p-5 hover:shadow-xl transition transform hover:-translate-y-1 duration-300 animate__animated animate__fadeInUp">
